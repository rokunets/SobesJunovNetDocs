### Support
#### Tech_support_error_email_without_@_regression
...
3. В появившемся окне в обязательном поле "введите Ваш e-mail" ввести адрес электронной почты без "@"
...
| --- | --- | --- | --- | --- |
| 2023-09-01 | 11:30 | Passed | Евгений | - | 